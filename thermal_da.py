...
base_path = r"C:\Users\Muskan\Desktop\collimator\data\FLIR_Knife_Tests\FLIR_Slantedge"
...
for folder in folders:
    ...
    if tif_files:
        ...
        # Normalize the edge spread function
        ...
        plt.title("Edge Spread Function Collimator")
    ...
    plt.title("Line Spread Function Collimator")
    plt.xlabel("Pixel Position")
    plt.ylabel("Normalized Intensity")
    plt.legend(title="Temperature")
    plt.grid()
    ...
    plt.title('Modulation Transfer Function Collimator')
